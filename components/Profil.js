...
function Profil() {
  ...
  const handleClickLogOut = () => {
    ...
    showTemporaryError(setIsLogOutSuccess);
    setTimeout(() => {
        ...
        <div className={styles.signForm}>
          <h1 className={`${styles.txtColor} ${styles.txtTitle}`}>
            <Image
              ...
              width={80}
            ></Image>
            Bienvenue {capitalizeWords(isUserConnected.firstName)}{" "}
            {capitalizeWords(isUserConnected.lastName)} !
          </h1>
          <div className={styles.inputContainer}>
            ...
            <input
              type="email"
              disabled
              placeholder={capitalizeWords(isUserConnected.firstName)}
              name="email"
          ...
          <div className={styles.inputContainer}>
            ...
            <input
              type="email"
              disabled
              placeholder={capitalizeWords(isUserConnected.lastName)}
              name="email"
              className={styles.input}
            />
            <FontAwesomeIcon
          ...
          <div className={styles.inputContainer}>
            ...
            <input
              type="email"
              disabled
              placeholder={`${isUserConnected.email}`}
              name="email"
              className={styles.input}
            />
            <FontAwesomeIcon
          ...
          {isLogOutSuccess && (
            <p className={styles.alertMessage}>Déconnection réussie !!!</p>
          )}
          <Button
            btnStyle="white"
            btnLocation="profil"
